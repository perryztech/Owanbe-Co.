        ...
        function trx_addons_resize_video(e, cont) {
            if ($video_tags.length > 0) {
                $video_tags.each(function() {
                    ...
                    if ((!TRX_ADDONS_STORAGE['resize_tag_video'] && $self.parents('.mejs-mediaelement').length === 0) || $self.hasClass('trx_addons_noresize') || classes.indexOf('_resize') > 0 || classes.indexOf('_noresize') > 0 || $self.parent().is('rs-bgvideo') || $self.parents('rs-slide').length > 0 || $self.parents('div:hidden,section:hidden,article:hidden').length > 0) {
                        return;
                    }
        ...
        if (elements.eq(0).hasClass('trx_addons_showed_on_scroll')) {
            ...
            elements.each(function(idx) {
                ...
                var completeTween = function() {
                    if (idx == elements.length - 1) {
                        ...
                        elements.each(function(idx2) {
                            jQuery(this).data('tweenmax-object', TweenMax.to(elements.eq(idx2), 0, {
                                overwrite: true,
                        ...
                        if (delimiters_loop > 0) {
                            delimiters.each(function(idx2) {
                                jQuery(this).data('tweenmax-delimiter', TweenMax.to(delimiters.eq(idx2), 0, {
                                    overwrite: true,
                                    rotation: 0,
                                    ease: Power0.easeNone
                                }));
                ...
                if (delimiters_loop > 0 && idx == elements.length - 1) {
                    delimiters.each(function(idx2) {
                        jQuery(this).data('tweenmax-delimiter', TweenMax.to(delimiters.eq(idx2), mw * time_per_pixel, {
                            overwrite: true,
